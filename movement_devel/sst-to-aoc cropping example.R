...
# Probably overcareful, but getting the correct names and positions of x/y dims in the
...
# provided data, which covers the whole world, using `st_bbox()` is appropriate
...
# crop to AOC
mock_aoc_bbox <- structure(c(xmin = -10, ymin = 50, xmax = 20, ymax = 60), class = "bbox") |> st_set_crs(4326)
