...
anim <- guill_history_long |>
  ...
  geom_sf(aes(col = owf_sensitive), size = 3, alpha = 0.3) +
...
the simulated populations. For example, the plots in the next figure compare
end‑of‑simulation body masses between paired baseline and impact runs. Most
agents show reduced final body masses under the impacted scenario, with the
magnitude of this reduction generally greater in OWF‑susceptible individuals.
