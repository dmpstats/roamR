...
- The IBM was programmed in R (open-source, transparent)
...
- Currently use of `romaR` is through markdown template i.e. a series of descriptions and code exemplars that are modified for user needs
