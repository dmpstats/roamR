...
Note: `install_github()` assumes that [RTools](https://cran.r-project.org/bin/windows/Rtools/) (on Windows) or an equivalent build toolchain is already installed for your version of R, as it is required to compile source packages.
